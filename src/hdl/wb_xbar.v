...
module wb_xbar(
    ...
    // ADC address = 0xF0000000
    wire adc_sel;
    assign adc_sel = (wb_adr[31:16] == 16'hFFD3) ? 1'b1 : 1'b0;
    ...
    assign wb_adc_stb = wb_stb & adc_sel;
    assign wb_i2s_cyc = wb_cyc & i2s_sel;
    assign wb_io_cyc = wb_cyc & io_sel;
    assign wb_sd_cyc = wb_cyc & sd_sel;
    assign wb_adc_cyc = wb_cyc & adc_sel;

    // Simply OR data response
    assign wb_dat_i = wb_i2s_dat_i | wb_io_dat_i | wb_sd_dat_i | wb_adc_dat_i;

    // Simply OR acks
    assign wb_ack = wb_i2s_ack | wb_io_ack | wb_sd_ack | wb_adc_ack ;
