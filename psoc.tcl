...
#
# psoc.tcl: Tcl script for re-creating project 'psoc'
#
# Generated by Vivado on Sun Feb 22 20:00:51 CET 2026
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/hdl/adc/adc_soc.v"]"\
 "[file normalize "$origin_dir/src/hdl/audio/adc_wb_regfile.v"]"\
 "[file normalize "$origin_dir/src/hdl/adc/cic_decimator.v"]"\
 ...
 "[file normalize "$origin_dir/src/hdl/adc/lvds_comparator.v"]"\
 "[file normalize "$origin_dir/ext/neosd/rtl/neosd_clken.v"]"\
 "[file normalize "$origin_dir/src/hdl/reset_logic.v"]"\
 "[file normalize "$origin_dir/src/hdl/adc/sd_sampling.v"]"\
 ...
 "[file normalize "$origin_dir/src/hdl/adc/adc_standalone_top.v"]"\
 ...
 "[file normalize "$origin_dir/../../psoc_soc/src/sim/tb_fpga_soc_top_behav.wcfg"]"\
 "[file normalize "$origin_dir/src/sim/tb_fpga_standalone_top.v"]"\
 "[file normalize "$origin_dir/ext/neorv32/sim/tb_wb_xbar_i2s.v"]"\
 "[file normalize "$origin_dir/src/sim/tb_sigma_delta_standalone.v"]"\
 "[file normalize "$origin_dir/../../psoc_soc/build/psoc/psoc.srcs/utils_1/imports/synth_1/fpga_soc_top.dcp"]"\
  ]
  foreach ifile $files {
...
set obj [get_filesets constrs_standalone]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/script/vivado/constr_standalone.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7z020clg484-1" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/script/vivado/constr_standalone.xdc"]" -objects $obj
...
set obj [get_filesets zedboard_standalone_top]
set_property -name "top" -value "fpga_standalone_top_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
set_property -name "xsim.simulate.runtime" -value "1000us" -objects $obj

# Create 'wishbone_reg' fileset (if not found)
if {[string equal [get_filesets -quiet wishbone_reg] ""]} {
  create_fileset -simset wishbone_reg
}

# Set 'wishbone_reg' fileset object
set obj [get_filesets wishbone_reg]
set files [list \
 [file normalize "${origin_dir}/ext/neorv32/sim/tb_wb_xbar_i2s.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'wishbone_reg' fileset file properties for remote files
# None

# Set 'wishbone_reg' fileset file properties for local files
# None

# Set 'wishbone_reg' fileset properties
set obj [get_filesets wishbone_reg]
set_property -name "top" -value "tb_wb_xbar_i2s" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
set_property -name "xsim.simulate.runtime" -value "1000us" -objects $obj

# Create 'sd_adc_standalone_testbench_set' fileset (if not found)
if {[string equal [get_filesets -quiet sd_adc_standalone_testbench_set] ""]} {
  create_fileset -simset sd_adc_standalone_testbench_set
}

# Set 'sd_adc_standalone_testbench_set' fileset object
set obj [get_filesets sd_adc_standalone_testbench_set]
set files [list \
 [file normalize "${origin_dir}/src/sim/tb_sigma_delta_standalone.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sd_adc_standalone_testbench_set' fileset file properties for remote files
# None

# Set 'sd_adc_standalone_testbench_set' fileset file properties for local files
# None

# Set 'sd_adc_standalone_testbench_set' fileset properties
set obj [get_filesets sd_adc_standalone_testbench_set]
set_property -name "top" -value "tb_sd_adc" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
set_property -name "xsim.simulate.runtime" -value "1000us" -objects $obj
...
set file "$origin_dir/../../psoc_soc/build/psoc/psoc.srcs/utils_1/imports/synth_1/fpga_soc_top.dcp"
set file [file normalize $file]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg484-1 -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_soc
} else {
...
set obj [get_runs synth_1]
set_property -name "constrset" -value "constrs_soc" -objects $obj
set_property -name "needs_refresh" -value "1" -objects $obj
set_property -name "part" -value "xc7z020clg484-1" -objects $obj
set_property -name "incremental_checkpoint" -value "/home/uskmn/Dokumente/psoc_soc/build/${_xil_proj_name_}/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/fpga_soc_top.dcp" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg484-1 -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_soc -parent_run synth_1
} else {
